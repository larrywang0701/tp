...
with(this){return _c('ul',[_c('li',[_v("When called upon to parse a user command, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" class creates an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v(" ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZ")]),_v(" is a placeholder for the specific command name e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommandParser")]),_v(") which uses the other classes shown above to parse the user command and create a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommand")]),_v(" object (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(") which the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddressBookParser")]),_v(" returns back as a "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Command")]),_v(" object.")]),_v(" "),_c('li',[_v("All "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("XYZCommandParser")]),_v(" classes (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommandParser")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("DeleteCommandParser")]),_v(", ...) inherit from the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Parser")]),_v(" interface so that they can be treated similarly where possible e.g, during testing.")]),_v(" "),_c('li',[_v("Some commands contains secondary command, like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add contact")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add note")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add event")]),_v(".")]),_v(" "),_c('li',[_c('ul',[_c('li',[_v("In this case, the primary command parser (in the example it is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddCommand")]),_v(") will check the secondary command word and use the correspond secondary command parser (like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddPersonCommandParser")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddEventCommandParser")]),_v(" and "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AddNoteCommandParser")]),_v(") to continue parsing the command.")])])]),_v(" "),_c('li',[_v("The parser will turn the arguments in the command from raw "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("String")]),_v(" into corresponding Object. During this process, the parser also needs to check whether the arguments are valid or not.")]),_v(" "),_c('li',[_c('ul',[_c('li',[_v("The parsing method for each types of arguments are mainly in "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ParserUtil.java")])])])]),_v(" "),_c('li',[_v("If the command is correct in format, the parser will then return a Command Object for the execution of the command.")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"enhanced-help-feature"}},[_v("Enhanced help feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#enhanced-help-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Rationale")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("Previous help feature simply opens a page with a link to the website, this is bad because:")]),_v(" "),_c('ul',[_c('li',[_v("The flow is lengthy")]),_v(" "),_c('li',[_v("User may not be able to access website when operating without the internet")])]),_v(" "),_c('p',[_v("Therefore, we want to make this better by simplifying the flow. We do this by adding:")]),_v(" "),_c('ul',[_c('li',[_v("Making the help command return things in the application console")]),_v(" "),_c('li',[_v("Letting users enter an extra argument to specify what command they need guiding on")])])])])}
},function anonymous(
) {
...
with(this){return _c('h2',{attrs:{"id":"planned-enhancements"}},[_c('strong',[_v("Planned Enhancements")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#planned-enhancements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("is seeking and applying to many jobs")]),_v(" "),_c('li',[_v("has the habit of taking many notes")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": manage information regarding many job offers in a organised and uncluttered manner for users who is comfortable with CLI apps.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("get a list of the commands")]),_v(" "),_c('td',[_v("know how to use the commands and their parameters")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new contact")]),_v(" "),_c('td',[_v("record one person's phone number and email address")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove a contact (by name) that I do not need")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view all contact")]),_v(" "),_c('td',[_v("easily see and know what contacts are currently stored in the application in one place")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("view all notes")]),_v(" "),_c('td',[_v("easily see and know what notes are currently stored in the application in one place")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add notes to a contact")]),_v(" "),_c('td',[_v("record additional information about that contact as a note")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete notes to a contact")]),_v(" "),_c('td',[_v("remove additional information about that contact that are no longer relevant")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user who has some event to do")]),_v(" "),_c('td',[_v("add an event")]),_v(" "),_c('td',[_v("record an event with start time and also end time, location and any additional information like what to do during the event")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user who has/had some event to do")]),_v(" "),_c('td',[_v("delete an event")]),_v(" "),_c('td',[_v("remove an event after it is obsolete, cancelled or no longer needed to be recorded")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("tidy user")]),_v(" "),_c('td',[_v("tag a contact with a label")]),_v(" "),_c('td',[_v("keep my contacts oraganised and categorised")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("tidy user")]),_v(" "),_c('td',[_v("delete a tag from a contact")]),_v(" "),_c('td',[_v("remove tags that are no longer relevant")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user who finishes using the application")]),_v(" "),_c('td',[_v("exit the program")]),_v(" "),_c('td',[_v("exit the program normally while ensuring all my data is currectly saved")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("KeepInTouch")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)")])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC01 - View command list")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view command list.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch shows the command list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 - Add a new contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch adds the contact to the list.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch shows the updated list of contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs incomplete or invalid data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a message indicating incomplete or invalid data.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC03 - Delete a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch deletes the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs a contact that does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. KeepInTouch shows a message indicating that the contact cannot be found.\nUse case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("2a. The contact list is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. KeepInTouch shows a message indicating the empty contact list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch shows all contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The contact list is empty.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. KeepInTouch shows a message indicating the empty contact list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Add a note to a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a note to a contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch adds a note to the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs incomplete data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a message indicating incomplete data.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs a contact that does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. KeepInTouch shows a message indicating that the contact cannot be found.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Delete a note from a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete an existing note from a contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch deletes the specified note from the contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs incomplete data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a message indicating incomplete data.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs a contact that does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. KeepInTouch shows a message indicating that the contact cannot be found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. User inputs a note that does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. KeepInTouch shows a message indicating that the note cannot be found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC07 - Add an event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add an event.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch adds the event.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs incomplete data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a message indicating incomplete data.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC08 - Delete an event")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete an event.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch deletes the event.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs incomplete data.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a message indicating incomplete data.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs an event that does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. KeepInTouch shows a message indicating that the event cannot be found.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC09 - Get help on commands")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests for help.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch returns relevant documentation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User inputs with no extra argument.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. KeepInTouch shows a list of all command words.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. User inputs with an extra argument corresponding to a command.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. Extra argument is a command word.")]),_v(" "),_c('ul',[_c('li',[_v("KeepInTouch returns documentation on that command word.")])])]),_v(" "),_c('li',[_c('p',[_v("1b2. Extra argument is not a command word, but is quite similar to a command.")]),_v(" "),_c('ul',[_c('li',[_v("KeepInTouch suggests the command word with the highest degree of similarity to the command input.")])])]),_v(" "),_c('li',[_c('p',[_v("1b3. Extra argument is not a command word, and isn't recognizably close to a command word.")]),_v(" "),_c('ul',[_c('li',[_v("KeepInTouch lets the user know that the command is unrecognizable.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC10 - Adding tags to a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add tags to a contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch appends that tags to the specified contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC11 - Delete tags from a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete tags from a contact.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch deletes the tags from the specified contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: UC12 - Exit the program")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit the program.")])]),_v(" "),_c('li',[_c('p',[_v("KeepInTouch exits the program.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 users without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("Should be able to hold up to 10000 contacts without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("All commands should be executed within two seconds.")]),_v(" "),_c('li',[_v("Should work without requiring any installer.")]),_v(" "),_c('li',[_v("Should work without requiring any internet connection.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The GUI should work well for standard screen resolutions 1920x1080 and higher, and, for screen scales 100% and 125%.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Fri, 10 Nov 2023, 14:27:05 GMT+8]")])])])}
}];
